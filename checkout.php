          ...
          <div class="col-lg-4">
            <div class="order_box">
                ...
                while ($row = mysqli_fetch_array($result)) {
                  ...
                  '<li>
                    <a href="#">
                      ...
                      <span class="last">Tk. ' . $row['qty'] * $row['price'] . '</span>
                    </a>
                  </li>';
              ...
              <ul class="list list_2">
                <li>
                  <a href="#">Subtotal
                    <span>Tk. <?php echo $sum ?></span>
                  </a>
                </li>
                <li>
                  <a href="#">Shipping(Tk. 49/product)
                    <span>Tk. <?php echo $quantity*49?></span>
                  </a>
                </li>
                <li>
                  <a href="#">Total
                    <span>Tk. <?php echo $sum + 49*$quantity ?></span>
                  </a>
                </li>
              </ul>
                <br><br>
